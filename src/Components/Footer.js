...
export default function Footer() {
  return (
    <div>
      <footer style={{backgroundColor: 'black'}} className="px-4 relative z-40  divide-y dark:bg-coolGray-800 dark:text-coolGray-100">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="space-y-3 ">
              <h3 className="tracking-wide uppercase text-violet">
                Product
              </h3>
            ...
            <div className="space-y-3">
              <h3 className="uppercase  text-violet">Developers</h3>
              <ul className="space-y-1">
                <li>
                  <a rel="noopener noreferrer" href="#">
                    Public API
            ...
            <div className="space-y-3">
              <div className="uppercase  text-violet">
                Social media
              </div>
